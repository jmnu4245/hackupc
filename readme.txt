...
Optionally, download the entire project file if you wish to explore the source code and understand how the game is made.
Usage
Execute the downloaded .exe file to start the game.
Features
...
Pau Navarro
Contact
Juan Manuel Flores: jmflodel@etsinf.upv.es
Daniel Galindo: dgalgoi1@etsid.upv.es
Pau Navarro: pnavarro@teleco.upv.es
